...
if result1 == -1:
    if result2 == -1:
        ...
        if x1==x2:
            x = x1
            y = x*(y4-y3)/(x4-x3) - x3*(y4-y3)/(x4-x3) + y3
        elif x3==x4:
            x = x3
    ...
    if result2 == -1:
        ...
        if (x1,y1)==(x3,y3):
            if ccw(p1,p3)==0:
                if (min(x3,x4)<=x2<=max(x3,x4) and min(y3,y4)<=y2<=max(y3,y4)) or\
            ...
            if ccw((x1-x2,y1-y2),(x4-x2,y4-y2))== 0:
            ...
            if ccw((x1-x2,y1-y2),(x3-x2,y3-y2))== 0:
                if (min(x3,x4)<=x1<=max(x3,x4) and min(y3,y4)<=y1<=max(y3,y4)) or\
                    (min(x1,x2)<=x3<=max(x1,x2) and min(y1,y2)<=y3<=max(y1,y2)):
                    print(1)
                else:
        ...
        elif (min(x1,x2)<=x3<=max(x1,x2) and min(y1,y2)<=y3<=max(y1,y2)) or\
